...
¡también nos ayudaron a lanzar FreeSaveVideo 10!
<BetaTesters />
...
meowbalt es la mascota veloz de FreeSaveVideo. es un gato extremadamente expresivo que ama el internet rápido.

todos los dibujos increíbles de meowbalt que ves en FreeSaveVideo fueron hechos por [GlitchyPSI](https://glitchypsi.xyz/).
...
el servidor de procesamiento de FreeSaveVideo es de código abierto y está licenciado bajo [AGPL-3.0]({docs.apiLicense}).

el frontend de FreeSaveVideo es [primero en fuente](https://sourcefirst.com/) y está licenciado bajo [CC-BY-NC-SA 4.0]({docs.webLicense}).
