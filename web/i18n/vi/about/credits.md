...
họ cũng đã giúp chúng tôi phát hành FreeSaveVideo 10!
<BetaTesters />
...
meowbalt là linh vật nhanh nhẹn của FreeSaveVideo. anh ấy là một con mèo cực kỳ biểu cảm yêu thích internet nhanh.

tất cả các bản vẽ tuyệt vời về meowbalt mà bạn thấy trong FreeSaveVideo đều được thực hiện bởi [GlitchyPSI](https://glitchypsi.xyz/).
...
máy chủ xử lý FreeSaveVideo là mã nguồn mở và được cấp phép theo [AGPL-3.0]({docs.apiLicense}).

giao diện người dùng FreeSaveVideo là [nguồn đầu tiên](https://sourcefirst.com/) và được cấp phép theo [CC-BY-NC-SA 4.0]({docs.webLicense}).
