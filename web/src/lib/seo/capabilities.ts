...
export const capabilityServices: CapabilityService[] = [
    ...
    },
    {
        ...
        batchFriendly: false,
        collectionFriendly: false,
        landingSlug: 'xinpianchang-video-download',
        notes: [
            'Supports individual public work URLs on xinpianchang.com with available progressive MP4 video.',
            'When browser verification prevents website parsing, complete verification manually, play the work, then use the Chrome or Edge FreeSaveVideo Downloader extension.',
            'The extension validates and saves the complete MP4 in the browser; keep its download tab open until saving finishes.',
            'Original uploads, fixed quality, private works, collection batches, and HLS/DASH merging are not promised.',
        ],
        searchIntents: ['新片场视频下载', '新片场下载器', 'Xinpianchang video downloader', 'download Xinpianchang MP4'],
        unsupportedCases: defaultUnsupportedCases,
    },
    {
        id: 'threads',
