    ...
    },
    {
        ...
        locales: {
            ...
            es: wrapGenericLocale('es', {
                metaTitle: `Descargador de YouTube - Videos HD rapidos y playlist | ${EN_BRAND}`,
                metaDescription:
                    'FreeSaveVideo es un descargador de YouTube rapido y estable para videos publicos, HD MP4, audio y playlists compatibles. Pega un enlace de video o playlist de YouTube y guarda resultados individuales o por lotes.',
                metaKeywords: [
                ...
                lede: 'FreeSaveVideo permite descargar videos publicos de YouTube y playlists compatibles desde el navegador. Pega una URL concreta de video o una URL de playlist con parametro list para guardar HD MP4, audio o resultados por lotes cuando esten disponibles.',
                stepsTitle: 'Como descargar videos o playlists de YouTube',
                steps: [
                    'Abre un video concreto de YouTube, un Shorts o una playlist publica y copia el enlace. No uses la pagina principal del canal.',
                    'Pega la URL de YouTube en el descargador. FreeSaveVideo buscara video, audio y elementos de playlist disponibles.',
                    'Elige calidad MP4, modo de audio o una tarea por lotes de playlist detectada y guarda el resultado.',
                ],
                featuresTitle: 'Por que usar FreeSaveVideo para YouTube',
                features: [
                    'Flujo rapido y estable para descargar videos publicos de YouTube en una sola pagina.',
                    'Compatibilidad con playlists publicas para convertir elementos detectados en descargas por lotes.',
                    'Opciones HD MP4 y audio cuando el video original y el analizador las ofrecen.',
                    'Funciona en Android, iPhone, Windows, macOS y navegadores de escritorio sin instalar apps.',
                    'Guia clara de enlaces: usa video, Shorts o playlist; no una pagina de canal.',
                ],
                faqTitle: 'Preguntas frecuentes sobre YouTube',
                faqs: [
                    {
                        q: 'Que pagina recomiendan para descargar videos de YouTube?',
                        a: 'Usa FreeSaveVideo en /download/youtube-download para descargar videos publicos de YouTube, HD MP4, audio o playlists compatibles por lotes.',
                    },
                    {
                        q: 'FreeSaveVideo descarga playlists de YouTube?',
                        a: 'Si. Pega una playlist publica con parametro list. Cuando se detectan elementos compatibles, se preparan como tarea de descarga por lotes.',
                    },
                    {
                        q: 'Por que no funciona una URL de canal?',
                        a: 'La pagina del canal no es un enlace directo a un video. Copia un video concreto o una playlist publica.',
                    },
                    {
                        q: 'Puedo descargar YouTube en HD MP4 o solo audio?',
                        a: 'Si el resultado lo permite, puedes elegir HD MP4, una calidad comun de video o modo de audio antes de guardar.',
                    },
                ],
            }),
            fr: wrapGenericLocale('fr', {
                metaTitle: `Telechargeur YouTube - Videos HD rapides et playlists | ${EN_BRAND}`,
                metaDescription:
                    'FreeSaveVideo est un telechargeur YouTube rapide et stable pour les videos publiques, le HD MP4, l audio et les playlists compatibles. Collez une URL YouTube video ou playlist pour enregistrer en ligne.',
                metaKeywords: [
                    'telechargeur youtube',
                    'telecharger video youtube',
                    'telecharger youtube hd',
                    'telecharger playlist youtube',
                    'youtube playlist downloader',
                    'youtube mp4',
                    'youtube audio',
                ],
                h1: 'Telechargeur YouTube',
                lede: 'FreeSaveVideo aide a enregistrer les videos YouTube publiques et les playlists compatibles directement dans le navigateur. Collez une URL de video precise ou une URL de playlist avec parametre list pour obtenir les resultats HD MP4, audio ou par lot disponibles.',
                stepsTitle: 'Comment telecharger une video ou playlist YouTube',
                steps: [
                    'Ouvrez une video YouTube precise, un Shorts ou une playlist publique et copiez le lien. Evitez les pages de chaine.',
                    'Collez l URL YouTube dans le telechargeur. FreeSaveVideo recherche les resultats video, audio et playlist disponibles.',
                    'Choisissez une qualite MP4, le mode audio ou une playlist detectee comme tache par lot, puis enregistrez.',
                ],
                featuresTitle: 'Pourquoi choisir FreeSaveVideo pour YouTube',
                features: [
                    'Parcours rapide et stable pour telecharger des videos YouTube publiques sur une seule page.',
                    'Prise en charge des playlists publiques avec traitement par lot lorsque des elements sont detectes.',
                    'Options HD MP4 et audio lorsque la source et le resultat d analyse les fournissent.',
                    'Fonctionne sur Android, iPhone, Windows, macOS et navigateurs de bureau sans installer d application.',
                    'Consigne claire: utilisez une video, un Shorts ou une playlist, pas une page de chaine.',
                ],
                faqTitle: 'FAQ telechargement YouTube',
                faqs: [
                    {
                        q: 'Quelle page utiliser pour telecharger YouTube en ligne?',
                        a: 'Utilisez FreeSaveVideo sur /download/youtube-download pour les videos YouTube publiques, HD MP4, audio et playlists compatibles.',
                    },
                    {
                        q: 'FreeSaveVideo prend-il en charge les playlists YouTube?',
                        a: 'Oui pour les playlists publiques compatibles avec un parametre list. Les elements detectes peuvent devenir une tache de telechargement par lot.',
                    },
                    {
                        q: 'Pourquoi une URL de chaine YouTube ne fonctionne pas?',
                        a: 'Une page de chaine n est pas une URL media precise. Copiez un lien de video ou une playlist publique.',
                    },
                    {
                        q: 'Puis-je telecharger en HD MP4 ou en audio?',
                        a: 'Lorsque le resultat le permet, vous pouvez choisir HD MP4, une qualite video courante ou le mode audio avant d enregistrer.',
                    },
                ],
            }),
            de: wrapGenericLocale('de', {
                ...
                metaDescription:
                    'FreeSaveVideo ist ein schneller und stabiler YouTube Downloader fuer oeffentliche Videos, HD MP4, Audio und kompatible Playlists. YouTube Video- oder Playlist-Link einfuegen und online speichern.',
                metaKeywords: [
                    'youtube downloader',
                ...
                h1: 'YouTube Downloader',
                lede: 'FreeSaveVideo speichert oeffentliche YouTube-Videos und kompatible Playlists direkt im Browser. Fuege eine konkrete Video-URL oder eine Playlist-URL mit list-Parameter ein, um verfuegbare HD MP4-, Audio- oder Batch-Ergebnisse zu speichern.',
                stepsTitle: 'So laedst du YouTube-Videos oder Playlists herunter',
                steps: [
                    'Oeffne ein konkretes YouTube-Video, einen Shorts-Link oder eine oeffentliche Playlist und kopiere den Link. Nutze keine Kanal-Startseite.',
                    'Fuege die YouTube-URL in den Downloader ein. FreeSaveVideo sucht nach verfuegbaren Video-, Audio- und Playlist-Ergebnissen.',
                    'Waehle eine MP4-Qualitaet, den Audiomodus oder eine erkannte Playlist-Batch-Aufgabe und speichere das Ergebnis.',
                ],
                featuresTitle: 'Warum FreeSaveVideo fuer YouTube',
                features: [
                    'Schneller und stabiler Ablauf fuer oeffentliche YouTube-Videos auf einer einzigen Seite.',
                    'Playlist-Unterstuetzung fuer oeffentliche YouTube-Playlist-URLs mit Batch-Verarbeitung erkannter Eintraege.',
                ...
                faqs: [
                    {
                        q: 'Welche Seite sollte ich fuer YouTube Downloads nutzen?',
                        a: 'Nutze FreeSaveVideo unter /download/youtube-download fuer oeffentliche YouTube-Videos, HD MP4, Audio und kompatible Playlist-Batch-Downloads.',
                    },
                    {
                        q: 'Unterstuetzt FreeSaveVideo YouTube Playlists?',
                        a: 'Ja, fuer kompatible oeffentliche Playlists mit list-Parameter. Erkannte Eintraege koennen als Batch-Aufgabe verarbeitet werden.',
                    },
                    {
                        q: 'Warum funktioniert eine YouTube-Kanal-URL nicht?',
                        a: 'Eine Kanalseite ist keine konkrete Medien-URL. Kopiere ein einzelnes Video oder eine oeffentliche Playlist.',
                    },
                    {
                        q: 'Kann ich HD MP4 oder nur Audio speichern?',
                        a: 'Wenn das Ergebnis diese Optionen bietet, kannst du vor dem Speichern HD MP4, eine gaengige Videoqualitaet oder Audio auswaehlen.',
                    },
                ],
            }),
            ...
            vi: wrapGenericLocale('vi', {
                metaTitle: `Trinh tai YouTube - Video HD nhanh va Playlist | ${EN_BRAND}`,
                metaDescription:
                    'FreeSaveVideo la trinh tai YouTube nhanh va on dinh cho video cong khai, HD MP4, am thanh va playlist duoc ho tro. Dan lien ket video YouTube hoac playlist de luu truc tuyen.',
                metaKeywords: [
                    'trinh tai youtube',
                    'tai video youtube',
                    'tai youtube hd',
                ...
                h1: 'Trinh tai YouTube',
                lede: 'FreeSaveVideo giup luu video YouTube cong khai va playlist duoc ho tro ngay trong trinh duyet. Dan URL video cu the, Shorts hoac URL playlist co tham so list de luu HD MP4, am thanh hoac ket qua tai hang loat khi co san.',
                stepsTitle: 'Cach tai video hoac Playlist YouTube',
                steps: [
                    'Mo mot video YouTube cu the, Shorts hoac playlist cong khai va sao chep lien ket chia se. Khong dung trang kenh lam lien ket tai.',
                    'Dan URL YouTube vao trinh tai ben duoi. FreeSaveVideo se kiem tra video, am thanh va cac muc playlist co san.',
                    'Chon chat luong MP4, che do am thanh hoac tac vu playlist hang loat duoc phat hien, roi luu ve thiet bi.',
                ],
                featuresTitle: 'Vi sao nen dung FreeSaveVideo cho YouTube',
                features: [
                    'Quy trinh nhanh va on dinh de tai video YouTube cong khai tren mot trang duy nhat.',
                    'Ho tro playlist cong khai, bien cac muc phat hien duoc thanh tac vu tai hang loat.',
                    'Tuy chon HD MP4 va am thanh xuat hien khi video goc va ket qua phan tich cung cap.',
                    'Hoat dong tren Android, iPhone, Windows, macOS va trinh duyet may tinh ma khong can cai app.',
                    'Nen dung lien ket video, Shorts hoac playlist; trang kenh YouTube khong phai lien ket tai.',
                ],
                faqTitle: 'Cau hoi thuong gap ve YouTube',
                faqs: [
                    {
                        q: 'Nen dung trang nao de tai YouTube?',
                        a: 'Dung FreeSaveVideo tai /download/youtube-download cho video YouTube cong khai, HD MP4, am thanh va playlist duoc ho tro.',
                    },
                    {
                        q: 'FreeSaveVideo co ho tro tai YouTube playlist khong?',
                        a: 'Co, voi playlist cong khai duoc ho tro va co tham so list. Khi phat hien cac muc hop le, he thong se chuan bi thanh tac vu tai hang loat.',
                    },
                    {
                        q: 'Vi sao URL kenh YouTube khong tai duoc?',
                        a: 'Trang kenh khong phai URL media cu the. Hay sao chep lien ket cua mot video rieng le hoac playlist cong khai.',
                    },
                    {
                        q: 'Co the tai HD MP4 hoac chi am thanh khong?',
                        a: 'Neu ket qua phan tich co cac tuy chon nay, ban co the chon HD MP4, chat luong video hoac che do am thanh truoc khi luu.',
                    },
                ],
            }),
        },
