...
const clerkCaptchaErrorCopy: Record<ClerkLocaleKey, string> = {
    ...
    id: "Verifikasi keamanan gagal. Perbarui Chrome, Edge, atau Firefox, atau coba lagi di jendela privat dengan ekstensi dinonaktifkan. Jika perlu, ganti jaringan.",
